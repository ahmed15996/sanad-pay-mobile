...
class CustomQrCodeScanSheetWidget extends StatefulWidget {
  const CustomQrCodeScanSheetWidget({super.key});

  @override
  State<CustomQrCodeScanSheetWidget> createState() =>
      _CustomQrCodeScanSheetWidgetState();
}

class _CustomQrCodeScanSheetWidgetState
    extends State<CustomQrCodeScanSheetWidget> {
  @override
  void initState() {
